...
> **Note:** The NemoClaw installer takes approximately 12 minutes to complete after the pod starts. For self-hosted GPU deployments, allow additional time for the NIM model to download and initialize.
